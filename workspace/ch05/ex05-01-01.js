...
// const liList = buyList.getElementsByTagName("li"); buyList안에서 찾을때
const liList = document.getElementsByTagName("li"); //문서 전체에서 찾을떄
...
//innerHTML 속성 사용
// console.log("innerHTML항목", firstLi.innerHTML);

//outerHTML 속성 사용
// console.log("outerHTML항목", firstLi.innerHTML);
firstLi.outerHTML = '<li>테스트</li>'
