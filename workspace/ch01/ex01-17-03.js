/*
if-else문문을 이용하여 사용자의 로그인 상태와 사용자의 등급을 출력하세요.
*/
...
if (loginStatus === "로그인 상태") {
    if (isUser) console.log(`구매자 ${loginStatus}`);
    if (isSeller) console.log(`판매자 ${loginStatus}`);
    if (isAdmin) console.log(`관리자 ${loginStatus}`);
